...
class AppLayout(FloatLayout):
    augmented_reality = ObjectProperty()
...
class ButtonsLayout(RelativeLayout):
    ...
    def screenshot(self):
        self.parent.augmented_reality.capture_screenshot()

    def select_camera(self, facing):
        self.parent.augmented_reality.select_camera(facing)

Builder.load_string("""
<AppLayout>:
    augmented_reality: self.ids.preview
    AugmentedReality:
        aspect_ratio: '16:9'
        id:preview
    ButtonsLayout:
